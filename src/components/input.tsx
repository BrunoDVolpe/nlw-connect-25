...
//Assim é o convencional. Ele mostrou com um pattern de composição, separando num mesmo arquivo o componente em partes menores pra permitir melhor flexibilidade e escalabilidade do componente
